...
class ObserverManager
{
    ...
    /// </summary>
    private readonly Dictionary<string, Action?> _specificObservers = new();
    ...
    /// <param name="observer">Observer method (usually from Presentation Layer) to be added</param>
    internal void AddObserver(string id, Action observer)
    {
    ...
    /// <param name="observer">Observer method (usually from Presentation Layer) to be removed</param>
    internal void RemoveObserver(string id, Action observer)
    {
    ...
    internal void NotifyItemUpdated(string id)
    {
